#!/usr/bin/env python3
"""
Recuperation des codes promo Loberon depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/loberon.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/loberon.fr"
STORE_NAME = "Loberon"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Loberon depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-loberon)"
    }
    try:
